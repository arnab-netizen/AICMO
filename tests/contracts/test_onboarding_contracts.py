"""
Contract tests for onboarding module.
...
def test_onboarding_dtos_are_pydantic():
...
def test_onboarding_events_have_required_fields():
    ...
    if len(event_classes) == 0:
        pytest.skip("No events defined for onboarding module yet")
...
def test_onboarding_api_has_no_internal_imports():
