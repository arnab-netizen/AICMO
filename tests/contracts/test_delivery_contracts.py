"""
Contract tests for delivery module.
...
def test_delivery_dtos_are_pydantic():
...
def test_delivery_events_have_required_fields():
    ...
    if len(event_classes) == 0:
        pytest.skip("No events defined for delivery module yet")
...
def test_delivery_api_has_no_internal_imports():
