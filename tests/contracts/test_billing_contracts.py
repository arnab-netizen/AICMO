"""
Contract tests for billing module.
...
def test_billing_dtos_are_pydantic():
...
def test_billing_events_have_required_fields():
    ...
    if len(event_classes) == 0:
        pytest.skip("No events defined for billing module yet")
...
def test_billing_api_has_no_internal_imports():
