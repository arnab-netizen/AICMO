"""
Contract tests for retention module.
...
def test_retention_dtos_are_pydantic():
...
def test_retention_events_have_required_fields():
    ...
    if len(event_classes) == 0:
        pytest.skip("No events defined for retention module yet")
...
def test_retention_api_has_no_internal_imports():
