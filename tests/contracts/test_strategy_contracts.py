"""
Contract tests for strategy module.
...
def test_strategy_dtos_are_pydantic():
...
def test_strategy_events_have_required_fields():
    ...
    if len(event_classes) == 0:
        pytest.skip("No events defined for strategy module yet")
...
def test_strategy_api_has_no_internal_imports():
