"""
Contract tests for reporting module.
...
def test_reporting_dtos_are_pydantic():
...
def test_reporting_events_have_required_fields():
    ...
    if len(event_classes) == 0:
        pytest.skip("No events defined for reporting module yet")
...
def test_reporting_api_has_no_internal_imports():
