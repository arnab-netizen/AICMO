"""
Contract tests for learning module.
...
def test_learning_dtos_are_pydantic():
...
def test_learning_events_have_required_fields():
    ...
    if len(event_classes) == 0:
        pytest.skip("No events defined for learning module yet")
...
def test_learning_api_has_no_internal_imports():
