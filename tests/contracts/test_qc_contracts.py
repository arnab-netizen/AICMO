...
def test_qc_events_have_required_fields():
    ...
    if len(event_classes) == 0:
        pytest.skip("No events defined for qc module yet")
...
def test_qc_api_has_no_internal_imports():
