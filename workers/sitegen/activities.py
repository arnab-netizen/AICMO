...
async def copyweb_write_all(site_id: str, spec: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "HeroSplit": {"title": spec.get("title", "Your Product"), "subtitle": spec.get("subtitle", "Do more with less.")},
        "FeaturesGrid": {"items": [{"title": "Fast", "body": "Blazing setup."}, {"title": "Secure", "body": "Policies enforced."}, {"title": "Scalable", "body": "From 0→1M users."}]},
